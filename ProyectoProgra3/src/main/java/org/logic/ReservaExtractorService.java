...
public interface ReservaExtractorService {
    @SystemMessage("""
        ...
        3. Para categorias Recurso SOLO puedes usar nombres que aparezcan EXACTAMENTE en la lista
    ...
    @UserMessage("""
        ...
        Frase del usuario:
        "{{frase}}"
        Extrae los datos de la reserva seleccionando las categorías que mejor correspondan a lo que el usuario describe.
        """)
