...
public class ActivityController {
    ...
    public void print() throws  Exception{
        ...
        header.addCell(getCell(new Paragraph("Listado de Calendarización de Actividades").setFont(fontBold).setFontSize(18), TextAlignment.CENTER, false));
        ...
        Cell headerFecha = new Cell()
                .add(new Paragraph("Fecha").setFont(fontBold).setFontColor(ColorConstants.WHITE))
                .setBackgroundColor(redColor)
                .setTextAlignment(TextAlignment.CENTER);
        ...
        ActivityData data = model.getActivityData();

       if (data != null && data.getDays() != null && data.getHours() != null){
           for (String hora: data.getHours()){
               for (LocalDate dia : data.getDays()){
                   String valor = data.getCell(hora,dia);
                   ...
                   if (valor != null && !valor.trim().isEmpty()){
                       ...
                       Cell datecell = new Cell()
                               .add(new Paragraph(dia.toString()).setFont(font))
                               .setTextAlignment(TextAlignment.CENTER);
